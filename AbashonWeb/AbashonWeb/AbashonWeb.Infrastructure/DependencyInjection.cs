...
using AbashonWeb.Infrastructure.Implementation;
using AbashonWeb.Infrastructure.Implementation.Repositories;
using AbashonWeb.Infrastructure.Implementation.Services;
using AbashonWeb.Infrastructure.Implementation.UOW;
...
namespace AbashonWeb.Infrastructure
{
    public static class DependencyInjection
    {
        public static void AddInfrusturctureLayer(this IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(IMapper<,>), typeof(MapsterMapper<,>));
        }
