    ...
    public static class ConfigureServiceContainer
    {
        ...
        public static void AddSwaggerOpenAPI(this IServiceCollection serviceCollection)
        {
            serviceCollection.AddSwaggerGen(setupAction =>
            {
                ...
                setupAction.SwaggerDoc(
                    ...
                    new OpenApiInfo()
                    {
                        Title = "Abashon WebAPI",
                        Version = "1",
                        Description = "Through this API you can access customer details",
                        Contact = new OpenApiContact()
                        {
                            Email = "abashonbd@gmail.com",
                            Name = "Abhi",
                            Url = new Uri("https://abashonbd.com/")
                        },
        ...
        public static void AddHealthCheck(this IServiceCollection serviceCollection, AppSettings appSettings, IConfiguration configuration)
        {
            serviceCollection.AddHealthChecks()
                ...
                .AddUrlGroup(new Uri(appSettings.ApplicationDetail.ContactWebsite), name: "Property Management System", failureStatus: HealthStatus.Degraded)
                .AddSqlServer(configuration.GetConnectionString("AbashonDbConn"));
